...
| `planning/` | **사용자가 무엇을 겪는가** (기획) | [경쟁 서비스 분석](planning/competitive-analysis.md) · [유저 저니](planning/user-journey.md) · [사이트맵](planning/sitemap.md) · [와이어프레임](planning/wireframes.html) |
