...
| `planning/` | **사용자가 무엇을 겪는가** (기획) | [경쟁 서비스 분석](planning/competitive-analysis.md) · [유저 저니](planning/user-journey.md) · [사이트맵](planning/sitemap.md) · [화면 흐름·와이어프레임](planning/flow.md) · [FAQ·푸터](planning/content.md) |
